...
namespace Lab8
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                CollectionType<String> l = new CollectionType<String>("Богдан", 0);
                CollectionType<String> a1 = new CollectionType<String>("Андрей");
                CollectionType<String> a2 = new CollectionType<String>("Иван");
                CollectionType<String> a3 = new CollectionType<String>("Павел");
                CollectionType<String> a4 = new CollectionType<String>("Ярослав");
                l.Add(a1);
                l.Add(a2);
                l.Add(a3);
                l.Add(a4);
